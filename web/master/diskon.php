...
$tampil = mysqli_fetch_array(mysqli_query($koneksi,"select * from harga where  keterangan like '%$time%' && status = '$role' && hari like'%$hariBahasaIndonesia%'"));
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <form method="post" action="../script/bayar_promo.php">
                                           ...
                                           <input type="hidden" name="tingkat" value="<?php echo $role;?>">
